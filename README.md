...
In these notebooks language modeling is used with regularization technique of Regularizing and Optimizing LSTM Language Models article
...
data is getting clean and nothing else than english words and numbers with afew symbols is going to vocabulary
 ...
 دیتا به صورت کلین شده به مدل داده میشود و کد های مقاله برای رگولاریزیشن در بعضی قسمت ها تغییر داده  شده اند 
